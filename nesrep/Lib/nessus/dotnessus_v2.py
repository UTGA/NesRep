...
class ReportItem(object):
    def __init__(self, xml_report_item):
        ...
        self.plugin_family = xml_report_item.attrib.get('pluginFamily')
        self.severity = xml_report_item.attrib.get('severity')
        self.description = xml_report_item.attrib.get('description')
        #output = xml_report_item.getchildren().attrib.get('plugin_output')
        #self.plugin_output = xml_report_item.attrib.get('plugin_output')
        ...
        for n in xml_report_item.getchildren():
            ...
            self.plugin_output = n.attrib.get('plugin_output')
    ...
    def __repr__(self):
        return "%s--%s--%s--%s--%s--%s--%s--%s" % (self.port, self.protocol, self.plugin_id, self.plugin_name, self.plugin_family, self.severity, self.description, self.plugin_output)
